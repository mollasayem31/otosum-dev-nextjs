  ...
  return (
    <div className="flex-none relative">
      <button
        ...
        className="flex flex-row justify-between px-2 py-3 text-gray-700 bg-white rounded-md  focus:outline-none focus:border-black
        border border-black w-full bg-transparent mt-1 focus:border-none focus:outline-green-500"
      >
